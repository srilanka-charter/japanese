...
const slides = [
  {
    image: "/manus-storage/fv-sri-lanka-sigiriya-kandy_bd15c5a6.webp",
    label: "TAXI CHARTER",
    title: "スリランカを\nタクシーチャーターで\n駆け抜ける",
  ...
  {
    image: "/manus-storage/fv-sri-lanka-tea-train_15d4f75c.webp",
    label: "TEA TRAIN",
    title: "紅茶列車で\n駆け抜ける\n高原の絶景",
  ...
  {
    image: "/manus-storage/fv-sri-lanka-safari_16f8c563.webp",
    label: "SAFARI",
    title: "野生の王国へ\nジープで\n踏み込む",
  ...
  {
    image: "/manus-storage/fv-sri-lanka-surfing_4fc9f83a.webp",
    label: "INDIAN OCEAN",
    title: "インド洋の\n碧い波に\n乗り込め",
    subtitle: "ミリッサをはじめとする南西海岸——椰子の木が連なる海で波を体感",
    badge: "ミリッサ・南西海岸",
  },
];
