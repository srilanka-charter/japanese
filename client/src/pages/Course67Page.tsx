...
const plans = [
  {
    id: 1,
    title: "世界遺産を巡るプラン",
    subtitle: "アヌラーダプラ・シーギリヤ・ポロンナルワ・キャンディ・コロンボ",
    tags: ["世界遺産", "文化遺産", "歴史"],
    days: [
      {
        day: 1,
      ...
      {
        day: 4,
        title: "ポロンナルワ遺跡 → キャンディ",
        items: [
          { type: "spot", text: "ポロンナルワ遺跡へ（約1.5時間）・観光（約2時間）" },
          { type: "food", text: "ランチ｜Rasa Bojun Gedara または Jaga Food" },
          { type: "spot", text: "キャンディへ移動（約3時間）・Gigarama Tea Factory 見学" },
          { type: "hotel", text: "キャンディ泊｜The Golden Crown Hotel / Cinnamon Citadel Kandy / Earl's Regent Hotel" },
        ],
      },
      {
        day: 5,
        title: "紅茶列車体験 → キャンディ仏歯寺",
        items: [
          { type: "spot", text: "キャンディ駅 11:15発 → Hatton 13:31着（紅茶列車）" },
          { type: "food", text: "ランチ｜Railway Lodge Restaurant または Tea Hills Restaurant" },
          { type: "spot", text: "チャーター車でキャンディへ戻る（約2時間）" },
          { type: "spot", text: "キャンディ仏歯寺 観光・余裕があればキャンディアンダンス（17:00〜）" },
          { type: "hotel", text: "キャンディ 連泊" },
        ],
      },
      {
        day: 6,
  ...
  {
    id: 2,
    title: "世界遺産を楽しみながら紅茶列車を満喫するプラン",
    subtitle: "キャンディ・エッラ・ゴール・ベントータ",
    tags: ["紅茶列車", "世界遺産", "ビーチ"],
    days: [
      {
        day: 1,
      ...
      },
      {
        ...
        items: [
          ...
          { type: "spot", text: "Giragama Tea Factory 見学・キャンディ仏歯寺 観光" },
      ...
      },
      {
        ...
        title: "ゴール要塞 → ベントータ",
        items: [
          { type: "spot", text: "南部の世界遺産都市ゴールへ（約3.5時間）・アマンガラでアフタヌーンティー" },
      ...
      },
      {
        ...
        title: "ベントータでビーチを満喫",
        items: [
          { type: "spot", text: "ホテルとビーチでのんびり過ごす" },
          { type: "spot", text: "CAPTAIN'S Boat House でボートサファリ（マングローブ）体験（約30分）" },
          { type: "hotel", text: "ベントータ 連泊" },
        ],
      },
      {
        day: 6,
  ...
  },
  {
    ...
    subtitle: "シーギリヤ・Ayugiri・Jetwing Ayurveda・コロンボ",
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          { type: "spot", text: "ホテルでアーユルヴェーダやヨガを満喫" },
          { type: "spot", text: "余裕があればピンナワラ象の孤児院へ（片道約2時間）" },
      ...
      },
      {
        ...
        title: "コロンボ観光 → 帰国フライト",
        items: [
          { type: "spot", text: "コロンボへ移動（約40分）・市内観光・お土産購入" },
          { type: "food", text: "アフタヌーンティー｜Galle Face Hotel または Shangri‑La Colombo" },
          { type: "flight", text: "コロンボ 19:50発" },
        ],
      },
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        title: "紅茶列車でエッラへ",
        items: [
          { type: "spot", text: "キャンディ駅 8:55発 → エッラ 15:38着" },
          { type: "food", text: "ランチボックス持参｜Buono または Cafe Secret Alley で調達" },
          { type: "hotel", text: "エッラ泊｜98 Acres Resort & Spa / HIDE ELLA HOTEL & RESORT" },
        ],
      },
      ...
      },
      {
        ...
        items: [
          { type: "spot", text: "ホテルとビーチでのんびり過ごす" },
          { type: "spot", text: "近郊でボートサファリ（マングローブ）体験も可" },
          { type: "hotel", text: "ベントータ 連泊" },
        ],
      },
      {
  ...
  {
    id: 5,
    title: "世界遺産とサファリ体験と紅茶列車とアーユルヴェーダ体験プラン",
    subtitle: "シーギリヤ・ミンネリヤ・キャンディ・ネゴンボ",
    tags: ["世界遺産", "サファリ", "紅茶列車", "アーユルヴェーダ"],
    days: [
      {
        day: 1,
        title: "成田 → ネゴンボ",
      ...
      },
      {
        ...
        items: [
          { type: "spot", text: "シーギリヤロック観光（約2時間）" },
          { type: "food", text: "ランチ｜Ahinsa Restaurant または Soul Food Café" },
          { type: "hotel", text: "ヘリタンスカンダラマ泊（希望があればアーユルヴェーダの事前予約可）" },
        ],
      },
      {
        day: 3,
      ...
      },
      {
        ...
        items: [
          { type: "spot", text: "キャンディ駅 11:15発 → Hatton 13:31着（紅茶列車）" },
          { type: "food", text: "ランチ｜Railway Lodge Restaurant または Tea Hills Restaurant" },
          { type: "spot", text: "チャーター車でキャンディへ戻る（約2時間）・仏歯寺観光・余裕があればキャンディアンダンス" },
          { type: "hotel", text: "キャンディ 連泊" },
        ],
      },
      {
        day: 5,
        title: "Jetwing Ayurveda Pavilionsへ",
        items: [
          { type: "spot", text: "Jetwing Ayurveda Pavilions（ネゴンボ）へ移動（約2.5時間）" },
          { type: "spot", text: "アーユルヴェーダ体験（Booking.comでトリートメント付きプランを予約推奨）" },
...
export default function Course67Page() {
  useEffect(() => {
    ...
    document.title = "スリランカ 6泊7日 モデルコース｜タクシーチャーターでゆったり周遊する旅";
    ...
    meta.content = "スリランカ6泊7日のモデルコースをご紹介。シーギリヤ・キャンディ・エッラ・コロンボなどをゆったり巡る専用タクシーチャーターの旅。日本語対応ドライバーが全行程をサポートします。";
      ...
      <section className="relative bg-[oklch(0.12_0.02_155)] pt-28 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="bg-[oklch(0.75_0.12_75)] text-[oklch(0.12_0.02_155)] text-xs font-black px-3 py-1 rounded-full tracking-widest">6泊7日</span>
          ...
          <p className="text-white/60 max-w-xl leading-relaxed">
            世界遺産・紅茶列車・アーユルヴェーダ・サファリ・ビーチリゾートを組み合わせた5プランをご用意。成田発着、タクシーチャーターで快適に巡るモデルコースです。
          </p>
