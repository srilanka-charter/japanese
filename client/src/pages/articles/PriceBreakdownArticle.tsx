      ...
      <section className="mb-14" id="section6">
        ...
        <div className="space-y-4">
          {[
            ...
            {
              q: "なぜ他のサービスより高いのですか？",
              a: "政府公認ライセンス保有ドライバーの採用、清潔で状態の良い車両の維持、日本語サポート体制の整備にコストをかけているためです。格安サービスとは提供できる品質が異なります。",
            },
            {
              q: "円安の影響で料金が上がりましたか？",
              a: "SLTCSの料金はスリランカルピーまたは米ドルベースで設定しています。円安が進んだ場合、円換算での金額は増加しますが、これはサービス内容の変化ではなく為替の影響です。",
            },
            {
              q: "追加料金が発生することはありますか？",
