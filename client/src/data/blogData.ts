...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    title: "スリランカで1日のタクシーチャーターをご希望の方へ",
    excerpt:
      "スリランカで1日だけ専用車をチャーターしたい方に向けて、プラットフォームを使ったドライバーの探し方から予約手順・WhatsAppの事前準備まで詳しく解説。シーギリヤ・キャンディ・コロンボなど人気観光地を指定して、自分だけのペースで巡るための実用情報をまとめました。",
    category: "タクシーチャーターの基礎",
    categorySlug: "taxi-charter-basics",
